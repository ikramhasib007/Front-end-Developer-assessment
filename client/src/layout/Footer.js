  ...
  return (
    <footer className="bg-white border-t" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto px-4 max-w-4xl sm:px-0 py-12">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className='px-10 space-y-2'>
              ...
              <Select
                className="focus:ring-neutral-500 focus:border-neutral-500 block w-full shadow-sm sm:text-sm border-gray-200 rounded-sm"
                options={[{ label: "INR", value: 'INR' },{ label: "US Dollar", value: 'US Dollar' }]}
                classNamePrefix="react-select"
                theme={reactSelectTheme}
                value={{ label: "INR", value: 'INR' }}
              />
            </div>
          </div>
        ...
        <div className="flex justify-between mt-10 border-t border-warm-gray-200 pt-5">
          <p className="text-xs text-warm-gray-600 xl:text-center">
            &copy; 2022 Airbnb, Inc.
          </p>
          <div className='flex space-x-3'>
            <div className='flex space-x-2'>
              <a href="#" className="text-xs text-warm-gray-700 hover:text-warm-gray-900">
                Terms
              </a>
              <a href="#" className="text-xs text-warm-gray-700 hover:text-warm-gray-900">
                Privacy
